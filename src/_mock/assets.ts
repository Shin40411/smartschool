...
export const _prices = [
  83740000, 97140000, 68710000, 85210000, 52170000, 25180000, 43840000, 60980000, 98420000,
  53370000, 72750000, 56610000, 64550000, 77320000, 60620000, 79810000, 93680000, 47440000,
  76240000, 92870000, 72910000, 20540000, 94250000, 37510000,
];
...
export const _productNames = [
  `Bộ học cụ STEM lớp 1`,
  `Robot lập trình thông minh`,
  `Bảng tương tác điện tử`,
  `Bộ cảm biến Arduino cơ bản`,
  `Bút trình chiếu không dây`,
  `Máy chiếu mini cho lớp học`,
  `Bộ công cụ học lập trình Scratch`,
  `Camera AI nhận diện khuôn mặt`,
  `Bộ thiết bị IoT cho học sinh`,
  `Bộ mạch Arduino nâng cao`,
  `Máy tính bảng cho giáo dục`,
  `Thiết bị đo nhiệt độ thông minh`,
  `Mô hình thực hành khoa học`,
  `Thiết bị hỗ trợ dạy học thực tế ảo (VR)`,
  `Bộ cảm biến môi trường lớp học`,
  `Xe lập trình robot điều khiển từ xa`,
  `Micro không dây dùng cho giảng dạy`,
  `Đồng hồ điểm danh học sinh`,
  `Tai nghe chống ồn học tập`,
  `Thiết bị điều khiển lớp học trung tâm`,
  `Camera giám sát lớp học`,
  `Màn hình tương tác cảm ứng`,
  `Bộ Kit lập trình Micro:bit`,
